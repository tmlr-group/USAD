...
builtins.CLEAN_PATH = "~/USAD/data/imagenet"
builtins.MODEL_ARCH = "Res50"
# pre-settings for adv path
adv_path = "~/USAD/adv"
# pre-settings for model
model_arch = "Res50"
ckpt = ""
model_path = os.path.join(adv_path + "/checkpoint/IMAGENET", model_arch, ckpt)

model = load_model(model_arch, model_path)

exp_path = "~/USAD/exp/main_exp/imagenet/res50"
